    ...
    return (
        <div className="col-md-10 mx-auto col-lg-5">
            <form className={`p-4 p-md-5 border rounded-3 ${props.mode === "dark" ? "bg-dark": "bg-body-tertiary"}`}>
                ...
                <div className={`text-center my-2 ${props.mode==="dark" && "darkMode"} ${props.sign === "in" && "d-none"}`}>OR</div>
                <button className={`w-100 btn btn-lg btn-${props.mode} d-flex gap-2 justify-content-center aling-items-center ${props.sign === "in" && "d-none"}`} type="submit">
